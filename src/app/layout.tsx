...
export const metadata: Metadata = {
  ...
  title: 'Vibrancy Piqtures | Photography & Cinematography',
  description: 'Best wedding photography and cinematography services in Kyanja. Capturing moments beautifully.',
  openGraph: {
    title: 'Vibrancy Piqtures | Photography & Cinematography',
